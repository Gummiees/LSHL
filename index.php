...
if (isset($_GET['q'])) {
	...
	if ($num > 0) {
		...
		echo '<div class="user-info"><div class="row"><div class="col-sm-3"><img src="'.$row['profile_pic'].'" alt="'.$row['username'].' profile image"></div><div class="col-sm-9"><div class="row username-profile">'.$row['username'].'</div><div class="row desc-profile">'.$row['user_desc'].'</div><div class="row email-profile" style="margin-top: 20px;"><i>Email: '.$row['email'].'</i></div><div class="row tel-profile"><i>Telephone: '.$row['telephone'].'</i></div><div class="row desc-profile"><b>Selling '.$num.' figures!</b></div></div></div></div>';
